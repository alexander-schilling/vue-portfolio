<template>
  <div>
    ...
    >
      ...
      <b-navbar-toggle target="nav-collapse" @click="onClick"></b-navbar-toggle>
      ...
      <b-collapse id="nav-collapse" :style="navCollapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown class="text-center" no-caret>
            ...
            <b-dropdown-item
              @click="
                $store.dispatch('setLocale', { locale: 'en', i18n: $i18n })
              "
              >English</b-dropdown-item
            >
            <b-dropdown-item
              @click="
                $store.dispatch('setLocale', { locale: 'es', i18n: $i18n })
              "
